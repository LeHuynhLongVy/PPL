...
//fragment DIGIT: [0-9];
//fragment NOZERO: [1-9];
//fragment IP: '0' | NOZERO DIGIT? DIGIT? ;
//IPV4: IP DOT IP DOT IP DOT IP;
//
////2
//ID: 'abc';
//EQ: '=';
...
//fragment DIGIT: [0-9];
//INTLIT: DIGIT+;
//FLOATLIT: DIGIT DOT DIGIT;
//STRINGLIT: '"' ('\\' ('t' | 'b' | 'f' | 'r' | 'n' | '\\') | '\\''"' | ~('\b' | '\f' | '\r' | '\n' | '\t' | '"' | '\\'))* '"'{self.text = self.text[1:-1]};
//
//program: variabledec*; // variable declarationS
//variabledec: assignment;
//assignment: ID EQ exp SEMI;
//
//array: indexarray | assocarray;
//
//indexarray: ARRAY LP explist RP;
//explist: exp nextexp | ;
//nextexp: COMMA exp nextexp | ;
//
//assocarray: ARRAY LP assocpairlist RP;
//assocpairlist: assocpair nextpair | ;
//nextpair: COMMA assocpair nextpair | ;
//assocpair: ID ARROW exp;
//
//
//exp: exp1 DQUES exp1 | exp1;
//exp1: exp2 ADD exp1 | exp2 SUB exp1 | exp2;
//exp2: exp2 MUL exp3 | exp2 DIV exp3 | exp2 MOD exp3 | exp3;
//exp3: exp3 DOT exp4 | exp4;
//exp4: exp5 DSTAR exp4 | exp5;
//exp5: subexp | operand;
//operand: ID | INTLIT | FLOATLIT | STRINGLIT | array;
//subexp: LP exp RP;
